...
This is the repo for reproducing the results in our manuscript **Neural Implicit Flow: a mesh-agnostic dimensionality reduction paradigm of spatio-temporal data**.
